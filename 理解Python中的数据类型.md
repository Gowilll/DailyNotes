...
## 📘 目录  
1. [★ Python整型不仅仅是一个整型](#python整型不仅仅是一个整型)  
2. [★ Python列表不仅仅是一个列表](#python列表不仅仅是一个列表)  
3. [★ Python中的固定类型数组](#python中的固定类型数组)  
4. [★ 从Python列表创建数组](#从python列表创建数组)  
5. [★ 从头创建数组](#从头创建数组)  
6. [★ Numpy标准数据类型](#numpy标准数据类型)
---
